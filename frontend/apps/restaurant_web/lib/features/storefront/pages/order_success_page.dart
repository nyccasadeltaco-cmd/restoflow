...
class OrderSuccessPage extends StatelessWidget {
  ...
  const OrderSuccessPage({super.key, required this.slug, required this.orderId});
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            Text(lang.t('success.title'),
                style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            Text(lang.t('success.code', vars: {'code': orderId}),
            ...
            ElevatedButton(
              ...
              child: Text(lang.t('success.backHome')),
            ),
          ],
        ),
      ),
